...
| `display.timeZone`          | string  | `""`             | IANA zone for those times and the usage row's time, e.g. `America/New_York`; empty uses the system zone. |
