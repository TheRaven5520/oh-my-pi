...
export type RedeemResetCreditOptions = {
	...
	baseUrlResolver?: (provider: string) => string | undefined;
	/**
	 * Provider idempotency key for the Codex consume call. Supply a stable value
	 ...
	 * spending a second credit; omitted, each call mints a fresh UUID. Claude
	 * resets manage their own request id via the pending-reset ledger.
	 */
